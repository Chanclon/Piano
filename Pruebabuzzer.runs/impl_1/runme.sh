...
HD_PWD='C:/proyectosvivado/Pruebabuzzer/Pruebabuzzer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MusicSystem_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MusicSystem_top.tcl -notrace
