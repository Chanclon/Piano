...
HD_PWD='C:/proyectosvivado/Pruebabuzzer/Pruebabuzzer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MusicSystem_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MusicSystem_top.tcl
